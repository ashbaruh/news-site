...
window.DB.sources = [
  ...
  },
  {
    ...
    note: 'פיד RSS ציבורי — כותרת מקורית + קישור בלבד, לכותרות על ישראלים בחו"ל. ' +
          'ובנוסף: לוח ותוצאות ליגת העל (עובדות: תאריך, קבוצות, תוצאה) מממשק הנתונים של עמוד הליגה, עם קישור לעמוד. ' +
          'החליף את ההתאחדות ב-17/09/2026: ההתאחדות חוסמת את הענן, והתוצאות ממנה נקראו בסדר הפוך.'
  },
  {
