...
window.DB.sources = [
  ...
  },
  {
    ...
    note: "מציג מניות, מדדים ונפט בשתי הגרסאות (CNBC חסם גישה). תנאי TradingView: הקרדיט בתוך הווידג'ט חייב להישאר, ואסור שימוש מסחרי בלי הסכם. " +
  ...
  },
  {
    ...
    note: 'פיד RSS ציבורי — כותרת מקורית + קישור בלבד. כותרות על ישראלים בחו"ל ועל קבוצות ישראליות באירופה.'
  },
  {
    id: 'src_one_data', name: 'ONE — נתוני ליגת העל', kind: 'נתוני משחקים (לא רשמי)',
    license_mode: 'personal_only', independence_group: 'media_one',
    attribution: 'תוצאות ולוח: ONE',
    note: 'ממשק הנתונים הפנימי של עמוד הליגה ב-ONE (כמו CNBC — לא שירות ציבורי מתועד). "שימוש אישי בלבד": ' +
          'בגרסה הציבורית מוצג רק קישור לטבלה ולתוצאות ב-ONE. החליף את ההתאחדות ב-17/09/2026 ' +
          '(ההתאחדות חוסמת את הענן, והתוצאות ממנה נקראו בסדר הפוך). לוח השידורים (LiveGames) נשאר גם בציבורי.'
  },
  {
  ...
  },
  {
    ...
    note: 'ציבורי מ-18/09/2026 (בקשת בעל האתר: לדעת מי משדר). מוצגות רק עובדות — ערוץ, שעה, משחק — של משחקי היום ' +
          'הרלוונטיים, עם קרדיט וקישור ללוח המלא; לא הלוח כולו. נקרא מדף האתר ולא מערוץ מידע רשמי. ' +
          'עובדות בלבד (ערוץ, שעה, משחק) + קישור ללוח המלא. כולל גם משחקי נוער/נשים בלי סימון — ' +
