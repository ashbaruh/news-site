...
window.DB.sources = [
  ...
  },
  {
    ...
    license_mode: 'personal_only', independence_group: 'data_livegames',
    attribution: 'שידורים: LiveGames',
    note: 'שימוש אישי בלבד (החלטה 17/09/2026): נקרא מדף האתר ולא מערוץ מידע רשמי — מוסתר בגרסה הציבורית. ' +
